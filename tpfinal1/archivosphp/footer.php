  ...
  <!-- ------------------------------------ -->
  <!-- Footer -->
  <footer class="page-footer font-small unique-color-white">
          ...
          <div class="container">
              ...
              <div class="row py-4 d-flex align-items-center">
                  ...
                  <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                      <h6 class="mb-0" style="font-size:18px;color:blue">Seguinos en redes sociales!</h6>
                  </div>
                   <!-- Grid column -->
      ...
      <div class="container text-center text-md-left mt-5 text-white">
          ...
          <div class="row mt-3">
              ...
              <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <!-- Content -->
                  <h6 class="text-uppercase font-weight-bold">VideoJuegos Store</h6>
                  <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                  <p>Un compañia al servicio
                      del jugador, intentando
                      darte la experiencia
                      que esperas.</p>
              ...
              <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                  ...
                  <!-- Links -->
                  <h6 class="text-uppercase font-weight-bold">Accesos</h6>
                  <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                  <p>
              ...
              <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                  ...
                  <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                  <p>
                      <svg class="bi bi-house mr-3" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor"
                  ...
                  <p>
                  <svg class="bi bi-phone mr-3" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  ...
  <path fill-rule="evenodd" d="M8 14a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"/>
      ...
      <div class="footer-copyright text-center py-3">© 2020 Copyright:
          <a href="index.php"> VideoJuegos store</a>
          <img src="./images/logo.png" width="40" height="40" alt="Logo Hoyts">
      </div>
      <!-- Copyright -->
